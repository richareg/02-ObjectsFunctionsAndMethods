...
def draw(color, thickness):
    ...
    thickTurtle = rg.SimpleTurtle('turtle')
    thickTurtle.pen = rg.Pen('green', thickness)

    coloredTurtle = rg.SimpleTurtle('turtle')
    coloredTurtle.pen = rg.Pen(color, 5)

    thickTurtle.backward(100)
    coloredTurtle.forward(100)
